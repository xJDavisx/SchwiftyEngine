...
namespace SchwiftyEngine
{
	public class Font
	{
		...
		internal Font(IntPtr fontPointer)
		{
			font = fontPointer;
		}
		...
		public Font(string path, int sizeInPoints)
		{
			LoadFont(path, sizeInPoints);
		}
		...
		public void LoadFont(string path, int sizeInPoints)
		{
			if (font != null)
			{
				TTF_CloseFont(font);
			}
			font = TTF_OpenFont(path, sizeInPoints);
		}
