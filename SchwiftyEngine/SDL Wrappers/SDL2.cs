...
/// <summary>
/// SDL2 wrapper classes used as the backend for the engine. Authored by Ethan "flibitijibibo" Lee.
/// Author Email: flibitijibibo@flibitijibibo.com
/// </summary>
namespace SDL2
{
	/// <summary>
	/// The wrapper for the base SDL2.dll
	/// </summary>
	public static class SDL
	{
		...
		/// <summary>
		/// The SDL initialize timer flag.
		/// </summary>
		public const uint SDL_INIT_TIMER = 0x00000001;

		/// <summary>
		/// The SDL initialize audio flag.
		/// </summary>
		public const uint SDL_INIT_AUDIO = 0x00000010;

		/// <summary>
		/// The SDL initialize video flag.
		/// </summary>
		public const uint SDL_INIT_VIDEO = 0x00000020;

		/// <summary>
		/// The SDL initialize joystick flag.
		/// </summary>
		public const uint SDL_INIT_JOYSTICK = 0x00000200;

		/// <summary>
		/// The SDL initialize haptic flag.
		/// </summary>
		public const uint SDL_INIT_HAPTIC = 0x00001000;

		/// <summary>
		/// The SDL initialize gamecontroller flag.
		/// </summary>
		public const uint SDL_INIT_GAMECONTROLLER = 0x00002000;

		/// <summary>
		/// The SDL initialize noparachute flag.
		/// </summary>
		public const uint SDL_INIT_NOPARACHUTE = 0x00100000;

		/// <summary>
		/// SDL_Init flag that initializes all SDL Subsystems.
		/// </summary>
		/// <remarks>
		/// Same as
		/// <c>
		...
		/// <summary>
		/// Initializes the SDL framework with the chosen flags.
		/// </summary>
		/// <param name="flags">The flags that decide what is initialized.</param>
		/// <returns></returns>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		*/
		...
		/// <summary>
		/// Creates a SDL_GLContext Pointer from an SDL_Window Pointer.
		/// </summary>
		/// <param name="window">SDL_Window Pointer.</param>
		/// <returns>A Pointer to the created SDL_GLContext.</returns>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <summary>
		/// Sets the minimum size of an SDL_Window.
		/// </summary>
		/// <param name="window">Pointer that refers to an SDL_Window</param>
		/// <param name="min_w">Minimum window width.</param>
		/// <param name="min_h">Minimum Window Height.</param>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <summary>
		/// Sets the position of an SDL_Window.
		/// </summary>
		/// <param name="window">Pointer that refers to an SDL_Window</param>
		/// <param name="x">X position of upper left corner.</param>
		/// <param name="y">Y position of upper left corner.</param>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <summary>
		/// Sets the size of an SDL_Window.
		/// </summary>
		/// <param name="window">Pointer that refers to an SDL_Window</param>
		/// <param name="w">Width of the SDL_Window.</param>
		/// <param name="h">Height of the SDL_Window.</param>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <summary>
		/// Flags for setting the BlendMode of an SDL Renderer.
		/// </summary>
		[Flags]
		public enum SDL_BlendMode
		{
			...
			/// <summary>
			/// Recommended for alpha transparency.
			/// </summary>
		...
		/// <summary>
		/// Init Flags for an SDL Renderer.
		/// </summary>
		[Flags]
